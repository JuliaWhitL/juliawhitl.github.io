...
The purpose of this study is to explore the behavior of several commonly used variance estimators under different data generating mechanisms (DGMs).
In particular we focus on the variance of the variance estimator (the "stability") and describe the relative trade-offs as they relate to bias and stability.
...
Generalized linear models (GLMs) "generalize" linear regression for exponential family distributions.
They increase model flexibility by:
...
![](/Users/juliawhitman/Documents/thesis/images/ci-example-weird.svg)

**Figure 1**: A simulated illustration of variance estimator instability.
The variance in the scenario on the left is stable, producing CIs of equal length.
The variance in the scenario on the right is ”unstable” by contrast, and produces CIs of varying lengths.

# Models

## Estimator validity

**Table 1.** Validity of variance estimators under three data generating mechanisms ![](/Users/juliawhitman/Documents/thesis/images/hypotheses-validity.jpg)

![](/densities-1.2.png){width="90%"}

**Figure 2.** Probability densities under Poisson $(\lambda = 2)$, quasi-Poisson $(\lambda = 2, \phi = 2)$, and negative binomial $(\mu = 2, \phi = 2)$ frameworks.
These discrete distributions are presented continuously to visualize differences in density and dispersion.

## Derivations

First specified a GLM and defined the mean model and mean-variance relationship.
We did this using a Poisson distribution with the mean model defined through a log link.

The Poisson density is re-written in canonical form, where the natural parameter is $\theta = log(\lambda)$ and scale parameter is $\phi = 1$.
Our mean model is defined as $g(E[Y]) = g(\mu) = g(b'(\theta)) = log(\theta)$:
...
![](/Users/juliawhitman/Documents/thesis/images/avg-se.svg){width="100%"}
...
The average bias of each estimator was computed as a percentage of the ESE.
The majority of estimators displayed "negative bias", resulting in an underestimate of the true variance and overstated certainty of the true parameter value.

![](/Users/juliawhitman/Documents/thesis/images/avg-bias-pois.svg){width="90%"}
...
![](/Users/juliawhitman/Documents/thesis/images/avg-bias-qp.svg){width="90%"}
...
![](/Users/juliawhitman/Documents/thesis/images/avg-bias-nb.svg){width="90%"}
...
![](/Users/juliawhitman/Documents/thesis/images/sdse-all.svg)
...
![](/Users/juliawhitman/Documents/thesis/images/sdse-pois.svg)
...
![](/Users/juliawhitman/Documents/thesis/images/sdse-correct.svg)
...
Negative binomial variance estimator was most stable in scenario B.
Meanwhile, the sandwich had lower stability, and bootstrap estimators performed similarly as in the prior example.
...
Performance of our six variance estimators was studied in a subset of the FAMS dataset.
Participants were included if they had complete data for:
...
![](/Users/juliawhitman/Documents/thesis/images/tbl-fams.png){width="40%"}
...
![](/Users/juliawhitman/Documents/thesis/images/tbl-fams-cat.jpg)

**Table 4.** Estimates of $\beta_1$ and SE for physical activity group, treated continuously

![](/Users/juliawhitman/Documents/thesis/images/tbl-fams-cont.jpg)
